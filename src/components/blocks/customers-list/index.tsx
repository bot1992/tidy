...
const CustomersList: FC<Props> = function ({
  customers,
  customersListDisplayStyle,
  customersListPadding,
}) {
  return (
    <Padding padding={customersListPadding} className="content-grid">
        ...
        <div className="grid gap-2 grid-cols-2 md:grid-cols-4">
          ...
          {customers.map((customer) => {
            ...
            return (
              <div
                key={id}
                className="flex items-center justify-center h-24 border border-slate-800 p-2"
              >
                {/* <svg
                className="max-w-full fill-slate-400"
                width="124"
                height="24"
                viewBox="0 0 124 24"
