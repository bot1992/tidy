...
const FeaturesList: FC<Props> = function ({ features, featuresListPadding }) {
  return (
    <Padding padding={featuresListPadding}>
      <div className="max-w-sm mx-auto md:max-w-none grid gap-12 md:grid-cols-3 md:gap-x-10 md:gap-y-10 items-start">
        ...
        {features.map((feature, index) => {
          ...
          const { id, title, description, image } = feature

          return (
            <article key={id} data-aos="fade-up">
