...
import { SocialMediaLabelType } from "../types"

type Props = {
  type: SocialMediaLabelType
} & SVGProps<SVGSVGElement>

const SocialMediaIcon: FC<Props> = function ({ type, className, ...props }) {
  const svgClassName = classNames("fill-current", className)
