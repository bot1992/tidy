...
import { fetchBlogPost, fetchBlogPostSlugs } from "@/src/graphql"
...
export async function generateMetadata({
  ...
  return {
    ...
    description: meta?.description ?? "Blog Post",
  }
}
            ...
            <div className="max-w-3xl mx-auto">
              <div className="mb-8">
                ...
                <div className="text-center md:text-left">
                  ...
                  <h1 className="h2 font-playfair-display text-slate-100 mb-6">
                    {post.title}
                  </h1>
                </div>
                {/* Article meta */}
